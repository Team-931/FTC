...
public class autoScoringController {
    ...
    public autoScoringController(Telemetry telemetry, HardwareMap hardwareMap) {
    ...
    public double getUpperArmPosition() {
        return upperArmServo.getPosition();
    }
